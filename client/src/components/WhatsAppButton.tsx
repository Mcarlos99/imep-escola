...
const WHATSAPP_NUMBER = "5594992435333";
const WHATSAPP_MESSAGE = "Olá, gostaria de mais informações sobre os cursos do IMEP.";
...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-16 top-1/2 -translate-y-1/2 bg-white px-4 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
